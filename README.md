...
------    | ----------- | ---------------- | ------------- | ----------- | ---------------- | ---- | -------------- | ------ |
bigint    | bigint array[5]      | bigint   | bigint        | varchar(50) | varchar(1000000) | int  | timestamp(UTC) | bool   |
...
- Чтение может отставать от записи (не консистентно). Только что отправленное письмо может не сразу появляться на странице писем.
